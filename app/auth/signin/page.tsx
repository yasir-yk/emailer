...
function SignInForm() {
  ...
  const callbackUrl = searchParams.get('callbackUrl') || '/dashboard/domains';
  ...
  return (
    <div className="w-full max-w-md glass-panel p-8">
      <div className="text-center mb-6">
        ...
        <h2 className="text-2xl font-bold text-white">Sign In to Emailer</h2>
        <p className="text-sm text-slate-400 mt-1">Manage custom sending domains & email campaigns</p>
      </div>
      ...
      <button
        ...
        type="button"
        className="w-full btn-secondary mb-4 flex items-center justify-center gap-3 py-2.5"
      >
